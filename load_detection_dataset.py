...
def read_conf():
    ...
    :rtype: dict
    """
    return load_json("./tweet_keys_file.json")
...
def load_pandas(pth, join=True):
    ...
    return get_pd_datas(data, columns, join)


def get_pd_datas(data, columns: Union[str, list], join: bool = True):
...
def list_detection_filename():
    files = glob("./dataset/detection/*/*tweet*.csv")
    return files
